...
<!--                        Mobile adv block-->
                        <?php if ( $show_ads ) :  ?>
                            <div class="mobile-ads-block" data-nosnippet="true" >
                                <div class="ads_image-block"><img src="<?php echo esc_url( $ads_image_url ) ?>" alt="ads-image" class="ads_image"></div>
                                <div class="mobile_ads_title"><?php echo esc_html( $ads_title ) ?></div>
                                <div class="mobile_ads_content"><?php echo esc_html( $ads_content ) ?></div>
                        ...
                        <?php if ( $show_post_ads ) : ?>
                            <div class="mobile-ads-block" data-nosnippet="true">
                                <div class="ads_image-block"><img src="<?php echo esc_url( $post_ads_image_url ) ?>" alt="ads-image" class="ads_image"></div>
                                <div class="mobile_ads_title"><?php echo esc_html( $post_ads_title ) ?></div>
                                <div class="mobile_ads_content"><?php echo esc_html( $post_ads_content ) ?></div>
                    ...
                    <div class="guider-blocks-widget guider-blocks-flex">
                        ...
                        <?php endif; ?>
                            ...
                            <?php if ( $show_ads || $show_post_ads) : ?>
                                <div class="ads-blocks">
                                    <?php if ( $show_ads ) : ?>
                                        <div class="ads-block" data-nosnippet="true">
                                            <div class="ads_image-block"><img src="<?php echo esc_url( $ads_image_url ) ?>" alt="ads-image" class="ads_image"></div>
                                            <div class="ads_title"><?php echo esc_html( $ads_title ) ?></div>
                                            <div class="ads_content"><?php echo esc_html( $ads_content ) ?></div>
                                            <div class="abs_button"><?php echo esc_html( $ads_button_text ) ?></div>
                                            <?php if ( $ads_text_under_btn ) : ?>
                                                <span class="abs_btn-notice"><?php echo esc_html( $ads_text_under_btn ); ?></span>
                                            <?php endif; ?>
                                    ...
                                    <?php if ( $show_post_ads ) : ?>
                                        <div class="ads-block" data-nosnippet="true">
                                            <div class="ads_image-block"><img src="<?php echo esc_url( $post_ads_image_url ) ?>" alt="ads-image" class="ads_image"></div>
                                            <div class="ads_title"><?php echo esc_html( $post_ads_title ) ?></div>
                                            <div class="ads_content"><?php echo esc_html( $post_ads_content ) ?></div>
                                            <div class="abs_button"><?php echo esc_html( $post_ads_link_url['title'] ); ?></div>
                                            <?php if ( $post_ads_text_under_btn ) : ?>
                                                <span class="abs_btn-notice"><?php echo esc_html( $post_ads_text_under_btn ); ?></span>
                                            <?php endif; ?>
